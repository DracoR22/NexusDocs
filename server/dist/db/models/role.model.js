...
exports.Role = Role;
__decorate([
    (0, sequelize_typescript_1.Column)(sequelize_typescript_1.DataType.ENUM('ADMIN', 'SUPERADMIN')),
    __metadata("design:type", String)
], Role.prototype, "name", void 0);
__decorate([
    (0, sequelize_typescript_1.BelongsToMany)(() => user_model_1.User, {
...
exports.Role = Role = __decorate([
    (0, sequelize_typescript_1.Table)({ tableName: 'role', underscored: true, timestamps: false })
], Role);
