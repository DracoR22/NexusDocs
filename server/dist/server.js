...
io.on('connection', (socket) => {
    ...
    if (!accessToken || !documentId) {
        ...
        jsonwebtoken_1.default.verify(accessToken, process.env.ACCESS_TOKEN, (err, decoded) => {
            ...
            document_service_1.default.findDocumentById(parseInt(documentId), parseInt(id))
                ...
                socket.on(socket_events_enum_1.default.SEND_CHANGES, (rawDraftContentState) => {
                    socket.broadcast.to(documentId).emit(socket_events_enum_1.default.RECEIVE_CHANGES, rawDraftContentState);
                });
