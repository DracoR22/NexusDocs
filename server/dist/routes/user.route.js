...
router.post('/create', user_validator_1.userValidator.register, user_controller_1.userController.register);
router.get('/:id', auth_1.authenticate, user_controller_1.userController.getUser);
router.post('/reset-password', user_validator_1.userValidator.resetPasssword, user_controller_1.userController.resetPassword);
