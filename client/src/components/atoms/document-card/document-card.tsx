...
const DocumentCard = ({ document, setDocuments}: DocumentCardProps) => {
  ...
  const handleDocumentBtnClick = (event: MouseEvent<HTMLDivElement>, documentId: number) => {
     ...
     if (!classList.contains(`documents-menu-btn-${documentId}`) && !classList.contains('document-menu')) {
       ...
       <div className="h-80 w-full border flex flex-col justify-between hover:border-blue-500 rounded">
          ...
          <div className="w-full h-24 border-t p-3">
            ...
            <div className="flex items-center justify-between">
              ...
              <svg xmlns="http://www.w3.org/2000/svg" className="h-8 w-8 text-white relative right-2" fill="#3b82f6" viewBox="0 0 24 24" stroke="currentColor" strokeWidth="1">
               ...
               <DocumentMenuButton documentId={document.id} setDocuments={setDocuments}/>
               )}
            </div>
          </div>
       </div>
